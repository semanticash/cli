...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.listAgentSessionsByProviderSessionIDStmt, err = db.PrepareContext(ctx, listAgentSessionsByProviderSessionID); err != nil {
		return nil, fmt.Errorf("error preparing query ListAgentSessionsByProviderSessionID: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.listAgentSessionsByProviderSessionIDStmt != nil {
		if cerr := q.listAgentSessionsByProviderSessionIDStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listAgentSessionsByProviderSessionIDStmt: %w", cerr)
		}
	}
