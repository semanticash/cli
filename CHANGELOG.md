...
- Hidden `semantica skills explain <ref>` backing command now emits structured JSON for skill integrations, using local provenance when available and a redacted git diff fallback otherwise.
