...
- Added bounded workspace snapshots for Claude Code Bash tools. Semantica captures before and after states in an isolated Git store, persists canonical deltas with crash-safe recovery, and seals incomplete groups so later captures continue independently.
